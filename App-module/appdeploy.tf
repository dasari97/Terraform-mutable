resource "null_resource" "apps" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "ansible-pull -i localhost -U https://dasarisaikrishna97@dev.azure.com/dasarisaikrishna97/Roboshop/_git/ansible-roboshop.git roboshop-pull.yml -e COMPONENT=${var.component} -e ENV=${var.env} -e APP_VERSION=1.1.1"
    ]
  }
